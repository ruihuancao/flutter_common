...
class Settings{
  ...
  Settings({this.textDirection, this.theme, this.platform, this.textScaleFactor});
  ...
  // 更新配置到shareprefences
  static Future<Null> update(Settings options) async{
  ...
  bool operator ==(dynamic other) {
    if (runtimeType != other.runtimeType)
      return false;
    final Settings typedOther = other;
